...
### Define parameters
  ...
  coalDivTimeLIG_mit <- 120000/(genlen*Ne)
  #coalDivTimeLGM_mit <- 21000/(genlen*Ne)
  coalDivTimeNS_0_LIG_mit <- DivTimeNS_0_LIG/(genlen*Ne)
  coalDivTimeSW_0_LIG_mit <- DivTimeSW_0_LIG/(genlen*Ne)
  #coalDivTimeSW_0_LGM_mit <- DivTimeSW_0_LGM/(genlen*Ne)
  #coalDivTimeNS_LGM_LIG_mit <- DivTimeNS_LGM_LIG/(genlen*Ne)
  #coalDivTimeNW_0_LGM_mit <- DivTimeNW_0_LGM/(genlen*Ne)
  coalDivTimeLIG_nuc <- 120000/(genlen*4*Ne)
  #coalDivTimeLGM_nuc <- 21000/(genlen*4*Ne)
  coalDivTimeNS_0_LIG_nuc <- DivTimeNS_0_LIG/(genlen*4*Ne)
  coalDivTimeSW_0_LIG_nuc <- DivTimeSW_0_LIG/(genlen*4*Ne)
  #coalDivTimeSW_0_LGM_nuc <- DivTimeSW_0_LGM/(genlen*4*Ne)
  #coalDivTimeNS_LGM_LIG_nuc <- DivTimeNS_LGM_LIG/(genlen*4*Ne)
  #coalDivTimeNW_0_LGM_nuc <- DivTimeNW_0_LGM/(genlen*4*Ne)
  ...
  GrowthRateN1_mit <- -(1/coalDivTimeNS_0_LIG_mit)*log(GrowthRatio)
  GrowthRateS1_mit <- -(1/coalDivTimeLIG_mit)*log(GrowthRatio)
  GrowthRateW1_mit <- -(1/coalDivTimeSW_0_LIG_mit)*log(GrowthRatio)
  GrowthRateN2_mit <- 0
  GrowthRateS2_mit <- 0
  GrowthRateW2_mit <- 0
  GrowthRateW3_mit <- 0
  GrowthRateN1_nuc <- -(1/coalDivTimeNS_0_LIG_nuc)*log(GrowthRatio)
  GrowthRateS1_nuc <- -(1/coalDivTimeLIG_nuc)*log(GrowthRatio)
  GrowthRateW1_nuc <- -(1/coalDivTimeSW_0_LIG_nuc)*log(GrowthRatio)
  GrowthRateN2_nuc <- 0
  GrowthRateS2_nuc <- 0
  GrowthRateW2_nuc <- 0
  GrowthRateW3_nuc <- 0
...
### ms's command
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 1 %f -en %f 3 %f -ej %f 3 2 -ej %f 1 2 -eg %f 2 0 | perl msSS.pl >> %s_ND2.txt", Nsam_ND2, theta_ND2, PopN_ND2, PopS_ND2, PopW_ND2, GrowthRateN1_mit, GrowthRateS1_mit, GrowthRateW1_mit, coalDivTimeNS_0_LIG_mit, BotN, coalDivTimeSW_0_LIG_mit, BotW, coalDivTimeSW_0_LIG_mit, coalDivTimeNS_0_LIG_mit, coalDivTimeLIG_mit, model4))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 1 %f -en %f 3 %f -ej %f 3 2 -ej %f 1 2 -eg %f 2 0 | perl msSS.pl >> %s_16S.txt", Nsam_16S, theta_16S, PopN_16S, PopS_16S, PopW_16S, GrowthRateN1_mit, GrowthRateS1_mit, GrowthRateW1_mit, coalDivTimeNS_0_LIG_mit, BotN, coalDivTimeSW_0_LIG_mit, BotW, coalDivTimeSW_0_LIG_mit, coalDivTimeNS_0_LIG_mit, coalDivTimeLIG_mit, model4))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 1 %f -en %f 3 %f -ej %f 3 2 -ej %f 1 2 -eg %f 2 0 | perl msSS.pl >> %s_SiaH.txt", Nsam_SiaH, theta_SiaH, PopN_SiaH, PopS_SiaH, PopW_SiaH, GrowthRateN1_nuc, GrowthRateS1_nuc, GrowthRateW1_nuc, coalDivTimeNS_0_LIG_nuc, BotN, coalDivTimeSW_0_LIG_nuc, BotW, coalDivTimeSW_0_LIG_nuc, coalDivTimeNS_0_LIG_nuc, coalDivTimeLIG_nuc, model4))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 1 %f -en %f 3 %f -ej %f 3 2 -ej %f 1 2 -eg %f 2 0 | perl msSS.pl >> %s_Rhodo.txt", Nsam_Rhodo, theta_Rhodo, PopN_Rhodo, PopS_Rhodo, PopW_Rhodo, GrowthRateN1_nuc, GrowthRateS1_nuc, GrowthRateW1_nuc, coalDivTimeNS_0_LIG_nuc, BotN, coalDivTimeSW_0_LIG_nuc, BotW, coalDivTimeSW_0_LIG_nuc, coalDivTimeNS_0_LIG_nuc, coalDivTimeLIG_nuc, model4))

## save parameter values
scenario2_parameters <- rbind(scenario2_parameters, data.frame(Ne, theta_ND2, theta_16S, theta_SiaH, theta_Rhodo, DivTimeNS_0_LIG, DivTimeSW_0_LIG, DivTimeSW_0_LGM, DivTimeNS_LGM_LIG, DivTimeNW_0_LGM, GrowthRatio, BotN, BotW))
}
...
for (i in 1:numsim) {
  ...
  GrowthRateW1_mit <- 0
  GrowthRateS1_mit <- 0
  GrowthRateN2_mit <- -(1/coalDivTimeLGM_mit)*log(GrowthRatio)
  GrowthRateW2_mit <- -(1/coalDivTimeSW_0_LGM_mit)*log(GrowthRatio)
  GrowthRateS2_mit <- -(1/coalDivTimeLGM_mit)*log(GrowthRatio)
  GrowthRateW3_mit <- 0
  GrowthRateN1_nuc <- 0
  GrowthRateW1_nuc <- 0
  GrowthRateS1_nuc <- 0
  GrowthRateN2_nuc <- -(1/coalDivTimeLGM_nuc)*log(GrowthRatio)
  GrowthRateW2_nuc <- -(1/coalDivTimeSW_0_LGM_nuc)*log(GrowthRatio)
  GrowthRateS2_nuc <- -(1/coalDivTimeLGM_nuc)*log(GrowthRatio)
  GrowthRateW3_nuc <- 0
...
### ms's command
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 3 %f -ej %f 3 2 -eg %f 1 0 -eg %f 2 0 -ej %f 2 1 | perl msSS.pl >> %s_ND2.txt", Nsam_ND2, theta_ND2, PopN_ND2, PopS_ND2, PopW_ND2, GrowthRateN2_mit, GrowthRateS2_mit, GrowthRateW2_mit, coalDivTimeSW_0_LGM_mit, BotW, coalDivTimeSW_0_LGM_mit, coalDivTimeLGM_mit, coalDivTimeLGM_mit, coalDivTimeNS_LGM_LIG_mit, model5))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 3 %f -ej %f 3 2 -eg %f 1 0 -eg %f 2 0 -ej %f 2 1 | perl msSS.pl >> %s_16S.txt", Nsam_16S, theta_16S, PopN_16S, PopS_16S, PopW_16S, GrowthRateN2_mit, GrowthRateS2_mit, GrowthRateW2_mit, coalDivTimeSW_0_LGM_mit, BotW, coalDivTimeSW_0_LGM_mit, coalDivTimeLGM_mit, coalDivTimeLGM_mit, coalDivTimeNS_LGM_LIG_mit, model5))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 3 %f -ej %f 3 2 -eg %f 1 0 -eg %f 2 0 -ej %f 2 1 | perl msSS.pl >> %s_SiaH.txt", Nsam_SiaH, theta_SiaH, PopN_SiaH, PopS_SiaH, PopW_SiaH, GrowthRateN2_nuc, GrowthRateS2_nuc, GrowthRateW2_nuc, coalDivTimeSW_0_LGM_nuc, BotW, coalDivTimeSW_0_LGM_nuc, coalDivTimeLGM_nuc, coalDivTimeLGM_nuc, coalDivTimeNS_LGM_LIG_nuc, model5))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 3 %f -ej %f 3 2 -eg %f 1 0 -eg %f 2 0 -ej %f 2 1 | perl msSS.pl >> %s_Rhodo.txt", Nsam_Rhodo, theta_Rhodo, PopN_Rhodo, PopS_Rhodo, PopW_Rhodo, GrowthRateN2_nuc, GrowthRateS2_nuc, GrowthRateW2_nuc, coalDivTimeSW_0_LGM_nuc, BotW, coalDivTimeSW_0_LGM_nuc, coalDivTimeLGM_nuc, coalDivTimeLGM_nuc, coalDivTimeNS_LGM_LIG_nuc, model5))
...
for (i in 1:numsim) {
  ...
  GrowthRateW2_mit <- 0
  GrowthRateS2_mit <- -(1/coalDivTimeLGM_mit)*log(GrowthRatio)
  GrowthRateW3_mit <- -(1/coalDivTimeNW_0_LGM_mit)*log(GrowthRatio)
  GrowthRateN1_nuc <- 0
  GrowthRateW1_nuc <- 0
  GrowthRateS1_nuc <- 0
  GrowthRateN2_nuc <- -(1/coalDivTimeLGM_nuc)*log(GrowthRatio)
  GrowthRateW2_nuc <- 0
  GrowthRateS2_nuc <- -(1/coalDivTimeLGM_nuc)*log(GrowthRatio)
  GrowthRateW3_nuc <- -(1/coalDivTimeNW_0_LGM_nuc)*log(GrowthRatio)
...
### ms's command
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 3 %f -ej %f 3 1 -eg %f 1 0 -eg %f 2 0 -ej %f 2 1 | perl msSS.pl >> %s_ND2.txt", Nsam_ND2, theta_ND2, PopN_ND2, PopS_ND2, PopW_ND2, GrowthRateN2_mit, GrowthRateS2_mit, GrowthRateW3_mit, coalDivTimeNW_0_LGM_mit, BotW, coalDivTimeNW_0_LGM_mit, coalDivTimeLGM_mit, coalDivTimeLGM_mit, coalDivTimeNS_LGM_LIG_mit, model6))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 3 %f -ej %f 3 1 -eg %f 1 0 -eg %f 2 0 -ej %f 2 1 | perl msSS.pl >> %s_16S.txt", Nsam_16S, theta_16S, PopN_16S, PopS_16S, PopW_16S, GrowthRateN2_mit, GrowthRateS2_mit, GrowthRateW3_mit, coalDivTimeNW_0_LGM_mit, BotW, coalDivTimeNW_0_LGM_mit, coalDivTimeLGM_mit, coalDivTimeLGM_mit, coalDivTimeNS_LGM_LIG_mit, model6))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 3 %f -ej %f 3 1 -eg %f 1 0 -eg %f 2 0 -ej %f 2 1 | perl msSS.pl >> %s_SiaH.txt", Nsam_SiaH, theta_SiaH, PopN_SiaH, PopS_SiaH, PopW_SiaH, GrowthRateN2_nuc, GrowthRateS2_nuc, GrowthRateW3_nuc, coalDivTimeNW_0_LGM_nuc, BotW, coalDivTimeNW_0_LGM_nuc, coalDivTimeLGM_nuc, coalDivTimeLGM_nuc, coalDivTimeNS_LGM_LIG_nuc, model6))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -g 1 %f -g 2 %f -g 3 %f -en %f 3 %f -ej %f 3 1 -eg %f 1 0 -eg %f 2 0 -ej %f 2 1 | perl msSS.pl >> %s_Rhodo.txt", Nsam_Rhodo, theta_Rhodo, PopN_Rhodo, PopS_Rhodo, PopW_Rhodo, GrowthRateN2_nuc, GrowthRateS2_nuc, GrowthRateW3_nuc, coalDivTimeNW_0_LGM_nuc, BotW, coalDivTimeNW_0_LGM_nuc, coalDivTimeLGM_nuc, coalDivTimeLGM_nuc, coalDivTimeNS_LGM_LIG_nuc, model6))
