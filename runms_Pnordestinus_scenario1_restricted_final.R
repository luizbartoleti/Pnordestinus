...
### Define parameters
  ...
  DivTime <- runif(1, 2000000, 5333000)
  ...
  coalDivTime_mit <- DivTime/(genlen*Ne)
  coalDivTime2_mit <- DivTime2/(genlen*Ne)
  coalDivTime_nuc <- DivTime/(genlen*4*Ne)
  coalDivTime2_nuc <- DivTime2/(genlen*4*Ne)
...
### ms's command
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -ej %f 3 1 -ej %f 2 1 | perl msSS.pl >> %s_ND2.txt", Nsam_ND2, theta_ND2, PopN_ND2, PopS_ND2, PopW_ND2, coalDivTime_mit, coalDivTime_mit, scenario1_model1))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -ej %f 3 1 -ej %f 2 1 | perl msSS.pl >> %s_16S.txt", Nsam_16S, theta_16S, PopN_16S, PopS_16S, PopW_16S, coalDivTime_mit, coalDivTime_mit, scenario1_model1))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -ej %f 3 1 -ej %f 2 1 | perl msSS.pl >> %s_SiaH.txt", Nsam_SiaH, theta_SiaH, PopN_SiaH, PopS_SiaH, PopW_SiaH, coalDivTime_nuc, coalDivTime_nuc, scenario1_model1))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -ej %f 3 1 -ej %f 2 1 | perl msSS.pl >> %s_Rhodo.txt", Nsam_Rhodo, theta_Rhodo, PopN_Rhodo, PopS_Rhodo, PopW_Rhodo, coalDivTime_nuc, coalDivTime_nuc, scenario1_model1))
...
### ms's command
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -en %f 3 %f -ej %f 3 2 -ej %f 2 1 | perl msSS.pl >> %s_ND2.txt", Nsam_ND2, theta_ND2, PopN_ND2, PopS_ND2, PopW_ND2, coalDivTime2_mit, Bot, coalDivTime2_mit, coalDivTime_mit, scenario1_model2))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -en %f 3 %f -ej %f 3 2 -ej %f 2 1 | perl msSS.pl >> %s_16S.txt", Nsam_16S, theta_16S, PopN_16S, PopS_16S, PopW_16S, coalDivTime2_mit, Bot, coalDivTime2_mit, coalDivTime_mit, scenario1_model2))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -en %f 3 %f -ej %f 3 2 -ej %f 2 1 | perl msSS.pl >> %s_SiaH.txt", Nsam_SiaH, theta_SiaH, PopN_SiaH, PopS_SiaH, PopW_SiaH, coalDivTime2_nuc, Bot, coalDivTime2_nuc, coalDivTime_nuc, scenario1_model2))
system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -en %f 3 %f -ej %f 3 2 -ej %f 2 1 | perl msSS.pl >> %s_Rhodo.txt", Nsam_Rhodo, theta_Rhodo, PopN_Rhodo, PopS_Rhodo, PopW_Rhodo, coalDivTime2_nuc, Bot, coalDivTime2_nuc, coalDivTime_nuc, scenario1_model2))
...
for (i in 1:numsim) {
  ...
  ### ms's command
  system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -en %f 3 %f -ej %f 3 1 -ej %f 1 2 | perl msSS.pl >> %s_ND2.txt", Nsam_ND2, theta_ND2, PopN_ND2, PopS_ND2, PopW_ND2, coalDivTime2_mit, Bot, coalDivTime2_mit, coalDivTime_mit, scenario1_model3))
  system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -en %f 3 %f -ej %f 3 1 -ej %f 1 2 | perl msSS.pl >> %s_16S.txt", Nsam_16S, theta_16S, PopN_16S, PopS_16S, PopW_16S, coalDivTime2_mit, Bot, coalDivTime2_mit, coalDivTime_mit, scenario1_model3))
  system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -en %f 3 %f -ej %f 3 1 -ej %f 1 2 | perl msSS.pl >> %s_SiaH.txt", Nsam_SiaH, theta_SiaH, PopN_SiaH, PopS_SiaH, PopW_SiaH, coalDivTime2_nuc, Bot, coalDivTime2_nuc, coalDivTime_nuc, scenario1_model3))
  system(sprintf("./ms %d 1 -t %f -I 3 %d %d %d -en %f 3 %f -ej %f 3 1 -ej %f 1 2 | perl msSS.pl >> %s_Rhodo.txt", Nsam_Rhodo, theta_Rhodo, PopN_Rhodo, PopS_Rhodo, PopW_Rhodo, coalDivTime2_nuc, Bot, coalDivTime2_nuc, coalDivTime_nuc, scenario1_model3))
